...
class LaserScan:
  ...
  def open_scan(self, filename):
    ...
    self.set_points(points[:, :3], remissions)
  ...
  def do_range_projection(self):
    ...
    print(self.proj_range.T.shape)
    #self.proj_range = self.proj_range.T
    self.image = np.stack((self.proj_range, self.proj_remission), axis=-1)



kitti_dir = "/media/ripon/Windows4/Users/ahrip/Documents/linux-soft/Kitti"
scan = LaserScan()
scan.open_scan(os.path.join(kitti_dir, "training/velodyne/000020.bin"))
print(scan.image.shape)

intensity_channel = scan.image[:, :, 1]
print(intensity_channel.shape)
plt.imshow(intensity_channel)
plt.show()